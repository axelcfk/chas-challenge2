            ...
            <div className="relative">
              {!isSearchOpen && (
                <button
                  ...
                  className="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-white focus:outline-none border-none focus:text-white bg-transparent ml-4"
