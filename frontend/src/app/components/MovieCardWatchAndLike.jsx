...
export default function MovieCardWatchAndLike({
  ...
  return (
    <div className="inline-block h-80 md:h-96 mx-4">
      {/* w-44 md:w-80 */}
          ...
          <div className="mt-4">
            <button
              ...
              className={`w-full h-12 bg-inherit border border-solid ${
                !watched ? "border-[#3D3B8E]" : profilePage ? "border-profile-page" : "border-green-600"}
              } hover:cursor-pointer flex justify-center items-center rounded-full box-border ${!watched ? "" : profilePage ? "profile-added-button" : "added-button"}`}
            >
              {!watched ? (
                <div className="w-full flex gap-2 justify-center items-center leading-none font-light text-gray-200">
                  <FaPlus className="text-lg leading-none text-gray-200" />

                  <p className="leading-none ">WATCHLIST</p>
                </div>
              ) : (
                <div className="w-full flex justify-center gap-2   items-center font-light text-gray-200">
                  <FaCheck className="text-lg leading-none text-gray-200" />
